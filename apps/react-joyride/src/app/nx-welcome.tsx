...
export const NxWelcome = ({ title }: { title: string }) => {
  const [step, setStep] = useState<StepI>({
    run: false,
    steps: [
      {
        target: '.klll',
      ...
      <div {...tooltipProps} style={{ paddingLeft: 200 }}>
        <Card className="w-96">
          <CardBody>
            ...
            {step.content && <Typography>{step.content}</Typography>}
          </CardBody>
      ...
      *,
      ...
      <div className="wrapper">
        <div className="container">
          ...
          <button onClick={handleClickStart}>Click me !</button>
          <div id="welcome" className="klll">
            <h1>
          ...
          <div id="commands" className="rounded">
            <h2>Next steps</h2>
